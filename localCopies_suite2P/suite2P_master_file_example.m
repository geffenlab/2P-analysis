%%
cd('C:\Users\2P-analysis\Documents\MATLAB\suite2P\localCopies') % start this code in the directory with make_db
make_db;

toolbox_path = 'C:\Users\2P-analysis\Documents\MATLAB\suite2P\Suite2P-master\';
...
ops0.RegFileRoot            = 'C:/data/_tempreg';

ops0.getROIs                = 1;
ops0.getSVDcomps            = 0;
ops0.nSVD                   = 100; % 1000 how many SVD components to keep

ops0.temp_tiff              = 'C:/DATA/temp.tiff'; % copy data locally first
ops0.ResultsSavePath        = 'E:\dataAnalysed\';
ops0.PhaseCorrelation       = 1; % set to 0 for non-whitened cross-correlation
ops0.SubPixel               = Inf; % 2 is alignment by 0.5 pixel, Inf is the exact number from phase correlation

ops0.showTargetRegistration = 1;
ops0.RootStorage            = 'C:/data/_tempreg/';
ops0.ShowCellMap            = 1;
